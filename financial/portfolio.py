...
def getPresentPrice(tickers,start,end):
...
class portfolio:
    def __init__(self,command:str,start:str,end:str):
        ...
        else: raise Exception("Input is not matching for command.")
    ...
    def profitCalc(self):
        ...
        PresentPrice=getPresentPrice(tickers,self.start,self.end)
